...
var XLSXX = {};
(function make_xlsx(XLSXX){
XLSXX.version = '0.8.11';
...
/* Parts enumerated in OPC spec, MS-XLSB and MS-XLSXX */
/* 12.3 Part Summary <SpreadsheetML> */
/* 14.2 Part Summary <DrawingML> */
/* [MS-XLSXX] 2.1 Part Enumerations */
...
/* [MS-OSHARED] 2.3.7.1 Hyperlink Object TODO: unify params with XLSXX */
...
function write_BrtFileVersion(data, o) {
	...
	write_XLWideString(XLSXX.version, o);
	write_XLWideString(XLSXX.version, o);
    ...
    return {
      ...
      _duckTypeStyle: function(attributes) {
        ...
        if (typeof attributes == 'object' && (attributes.patternFill || attributes.fgColor)) {
          return {fill: attributes }; // this must be read via XLSXX.parseFile(...)
        }
...
XLSXX.parse_xlscfb = parse_xlscfb;
XLSXX.parse_zip = parse_zip;
XLSXX.read = readSync; //xlsread
XLSXX.readFile = readFileSync; //readFile
XLSXX.readFileSync = readFileSync;
XLSXX.write = writeSync;
XLSXX.writeFile = writeFileSync;
XLSXX.writeFileSync = writeFileSync;
XLSXX.utils = utils;
XLSXX.CFB = CFB;
XLSXX.SSF = SSF;
})(typeof exports !== 'undefined' ? exports : XLSXX);
var XLS = XLSXX;
